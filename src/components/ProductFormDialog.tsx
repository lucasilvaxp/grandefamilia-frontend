...
export function ProductFormDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('[ProductFormDialog] Response status:', response.status);
      ...
      if (response.ok) {
        ...
        console.error('[ProductFormDialog] Error response:', error);
        toast.error(error.error || 'Erro ao salvar produto');
      }
    } catch (error) {
      console.error('[ProductFormDialog] Error saving product:', error);
